...
/**
 * <div>
 * Many files were lost that all relied on one another (inherited). These lost files were thoughtfully reimplemented to the best of my
 * abilities in accordance with the only files that remained: <code>Server</code> and <code>DataGenerator</code>, using their
 * current code, which pertained to many different object's method calls, allowing me to reconstruct them.
 * </div>
 *
 * <div>
 * <p> Request stood at the top of the hierarchy, with PostRequest and GetRequest inheriting as child classes. </p>
 * <p> PostPaymentRequest and PostFormRequest inherited from PostRequest. </p>
 * <p> PostEncryptedPaymentRequest inherited from PostPaymentRequest, and PostEncryptedFormRequest inherited from PostFormRequest. </p>
 * <p> On the other end, GetFileRequest and GetVideoRequest inherited both from GetRequest. </p>
 * </div>
 */
public class Server {
